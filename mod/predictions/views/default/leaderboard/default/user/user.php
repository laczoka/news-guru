...
<div style="padding-left: 10px; padding-bottom: 5px">
 ...
 <div style="float:left;padding-left: 5px">
    ...
    <div style="padding-left: 5px;float:left;">
             Free Cash Balance $ <?php echo $user->opendollars ?><br />
             Total Net Asset $ <?php echo isset($user->report_total_net_asset_value) ? $user->report_total_net_asset_value : $user->opendollars ?>
    </div>
